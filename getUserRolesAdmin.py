...
# Gets a list of a user's roles and the associated administrative rights
...
url = 'https://%s/UserMgmt/GetUsersRolesAndAdministrativeRights/' % tenant
...
# username can be passed in body of post method but so can uuid
...
print '****************************************************************'
print ' '
print 'Sending HTTPS POST Request for /UserMgmt/GetUsersRolesAndAdministrativeRights '
print ' '
print '****************************************************************'
print ' '
print 'JSON Response: '
