...
url = 'https://%s/SaasManage/StoreRole/' % tenant
...
r = requests.post(url, json = {
  "Name": "New_API_Role",
  "Description": "This is an API created version of the Role description"
...
print '****************************************************************'
print ' '
print 'Sending HTTPS POST Request for /SaasManage/StoreRole '
print ' '
print '****************************************************************'
print ' '
print 'JSON Response: '
