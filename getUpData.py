...
#/UPRest/GetUpData
# Gets information for all the applications that are deployed for the specified user.
...
url = 'https://%s/UPRest/GetUpData/' % tenant
...
print '****************************************************************'
print ' '
print 'Sending HTTPS POST Request for /UPRest/GetUpData '
print ' '
print '****************************************************************'
print ' '
print 'JSON Response: '
