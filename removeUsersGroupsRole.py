...
url = 'https://%s/SaasManage/RemoveUsersAndGroupsFromRole/' % tenant
...
# Users (Array[string], optional): List of user UUIDs or Names to remove from the role (default=null) ,
# Groups (Array[string], optional): List of group UUIDs or Names to remove from the role (default=null) ,
# Roles (Array[string], optional): List of role UUIDs or Names to add remove from role (default=null)
...
print '****************************************************************'
print ' '
print 'Sending HTTPS POST Request for /SaasManage/RemoveUsersAndGroupsFromRole '
print ' '
print '****************************************************************'
print ' '
print 'JSON Response: '
